...
- Command paths still enforce the active vault boundary through the Rust command layer before reads, writes, and attachment imports.
...
- Active-vault command validation remains the primary guard for mutations.
