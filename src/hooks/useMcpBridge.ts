/**
 * Hook for communicating with the Artemis MCP WebSocket bridge.
 *
...
const DEFAULT_WS_URL = import.meta.env.VITE_ARTEMIS_MCP_WS_URL
  || import.meta.env.VITE_MCP_WS_URL
  || `ws://localhost:${import.meta.env.VITE_ARTEMIS_MCP_WS_PORT || import.meta.env.VITE_MCP_WS_PORT || '9710'}`
