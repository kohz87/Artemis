...
const CARD_STYLE: React.CSSProperties = {
  ...
  padding: 'var(--welcome-card-padding, 48px)',
  display: 'flex',
  flexDirection: 'column',
  alignItems: 'center',
  gap: 'var(--welcome-card-gap, 24px)',
  minWidth: 0,
}
...
const TITLE_STYLE: React.CSSProperties = {
  fontSize: 'var(--welcome-title-size, 28px)',
  fontWeight: 700,
  letterSpacing: 0,
...
function OptionButton({
  ...
  return (
    <Button
      ...
      data-testid={testId}
      autoFocus={autoFocus}
      className="h-auto min-w-0 justify-start whitespace-normal shadow-none"
      ref={buttonRef}
    >
      ...
      <div className="welcome-option-copy">
...
> & {
  ...
  useEffect(() => {
    ...
    // Embedded webviews can ignore `autoFocus`; move focus explicitly so keyboard-only
      ...
      <>
        ...
        <div style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: 10 }}>
          ...
          <OptionButton
            ...
            description="Start fresh in an empty folder with Artemis defaults"
            loadingLabel="Creating vault..."
            loadingDescription="Preparing Artemis defaults in the selected folder"
