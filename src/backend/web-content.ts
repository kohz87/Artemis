 ...
 * Used by the mock desktop layer when running in browser dev mode.
 */
...
published: true
archived: false
tags: [desktop, React, TypeScript, CodeMirror]
...
- [x] Luca: set up desktop v2 project scaffold
...
- **Desktop**: desktop, Electron alternatives
