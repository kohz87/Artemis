...
export const MOCK_ENTRIES: VaultEntry[] = [
  ...
  },
  {
    ...
    fileSize: 1024,
    snippet: 'Build a sustainable audience through high-quality weekly essays on engineering leadership, writing craft, and personal systems.',
    wordCount: 215,
    relationships: {
      'Has': [
    ...
    sidebarLabel: null,
    template: null, sort: null, view: null, visible: null,
    outgoingLinks: ['on-writing-well', 'engineering-leadership-101', 'growth', 'writing'],
  ...
  // --- Custom type documents ---
  {
    ...
    createdAt: now - 86400 * 365,
    fileSize: 300,
    snippet: 'Vault configuration files. These describe local note types, views, and other vault metadata.',
    wordCount: 25,
    relationships: {},
    icon: 'gear-six',
    color: 'gray',
