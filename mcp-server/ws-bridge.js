#!/usr/bin/env node
/**
 * WebSocket bridge for Artemis MCP tools.
 *
 * Exposes vault operations over WebSocket so the Artemis app frontend
 * can invoke MCP tools in real-time without going through stdio.
 *
 * Default port 9710: Tool bridge — Claude/AI clients call vault tools here.
 * Default port 9711: UI bridge — Frontend listens for UI action broadcasts.
 *
 * Usage:
...
const WS_PORT = envPort(['WS_PORT', 'ARTEMIS_MCP_WS_PORT', 'MCP_WS_PORT'], 9710)
 ...
 * is unavailable (e.g. another Artemis instance owns it).
 */
